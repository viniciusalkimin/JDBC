...
public class CategoriaDAO {
	...
	public List<Categoria> listarComProduto() throws SQLException {
		...
		try(PreparedStatement pstm = connection.prepareStatement("SELECT C.ID, C.NOME, P.ID, P.NOME, P.DESCRICAO FROM CATEGORIA C INNER JOIN PRODUTO P ON C.ID = P.CATEGORIA_ID")) {
			pstm.execute();
